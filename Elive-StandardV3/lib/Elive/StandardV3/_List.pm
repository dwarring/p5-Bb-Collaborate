package Elive::StandardV3::_List;
...
Elive::StandardV3::_List - Base class for lists.
...
coerce 'Elive::StandardV3::_List' => from 'ArrayRef'
          => via {
	      my @items = grep {$_ ne ''} map {split(',')} @$_;
	      Elive::StandardV3::_List->new(\@items);
};

coerce 'Elive::StandardV3::_List' => from 'Str'
          => via {
