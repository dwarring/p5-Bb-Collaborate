...
my $class = 'Elive::StandardV3::Session' ;
...
SKIP: {
    ...
    my $session_name_untainted = 'test session, generated by t/soap-taint-mode.t(' . t::Elive::StandardV3::generate_id() . ')';
    ...
    isnt (sub {$sessions = Elive::StandardV3::Session->list(filter => {sessionName => $session_name_tainted})} => undef,
	'List with tainted filter - dies');
  
    is ( exception {$sessions = Elive::StandardV3::Session->list(filter => {sessionName => $session_name_untainted})} => undef,
