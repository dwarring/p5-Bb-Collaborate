...
Oracle or MySQL. These are supported by Elluminate and have JDBC bridges
available.

Elluminate Live! also bundles JDBCScriptTool and JDBCQueryTool.
At a pinch you can either to obtain basic SQL access to McKoi databases.
